	...
	return (
		<section className='aboutMeSection'>
            ...
            <section className='textMain'>
                ...
                {isServicesPage ? (
                <h1>Разделяю большие и сложные задачи<br></br>на самодостаточные и прозрачные этапы,<br></br>чтобы клиент всегда знал, как движется<br></br>его проект.</h1>
                ) : (
                    <React.Fragment>
                        <h1>Я люблю продуманный дизайн. Стремлюсь<br></br>к понятности, простоте и эстетике.<br></br>Пробую современные визуальные решения.<br></br>Каждая моя работа — это вызов самому себе.</h1>
